...
<head>
    ...
    <!-- FAVICON -->
    <link href="{{ asset('back/img/favicon.png') }}" rel="shortcut icon" />
    ...
    <div class="wrapper">
        ...
        <aside class="left-sidebar bg-sidebar">
          <div id="sidebar" class="sidebar sidebar-with-footer">
            ...
            <div class="app-brand">
              <a href="/back/index">
                <img src="{{ asset('images/logos/fav.png') }}" alt="" style="border-radius: 8px">
                {{-- <svg
                  class="brand-icon"
                  ...
                  <li  class="has-sub" >
                    ...
                    <ul  class="collapse"  id="dashboard"
                      ...
                      <div class="sub-menu">
                            ...
                            <li  class="" >
                                <a class="sidenav-item-link" href="#">
                                  <span class="nav-text">Programs Name & Logo</span>                                
                                </a>
                            </li>
                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user-menu">
                    <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                      <img src="{{ asset('back/img/user/user.png') }}" class="user-image" alt="User Image" />
                      <span class="d-none d-lg-inline-block">Anowar Hosen</span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-right">
                      <!-- User image -->
                      <li class="dropdown-header">
                        <img src="{{ asset('back/img/user/user.png') }}" class="img-circle" alt="User Image" />
                        <div class="d-inline-block">
                          Anowar Hosen <small class="pt-1">anowar@gmail.com</small>
                        </div>
                      </li>
            ...
            <div class="copyright bg-white">
              ...
              <p>
                <span>Copyright &copy; <script>
                  ...
                  </script> - Developed by  <a href="https://czm-bd.org/">Anowar Hosen</a></span>
              </p>
            </div>
          </footer>
