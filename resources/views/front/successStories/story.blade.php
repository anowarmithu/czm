  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-8 mb-5 mb-lg-0">
              ...
              <b style="color: red">Story / Insaniat </b>  <br>  We Just Completes $17.6 million Medical Clinic in Mid-Missouri
              </h2>
              ...
              <div class="post-meta">
                ...
                <span class="post-cat">
                  <i class="far fa-folder-open"></i><a href="#"> Story</a>
                </span>
        ...
        <div class="post-content post-single">
          <div class="post-media post-image">
            <img loading="lazy" src="{{ asset('images/news/news1.jpg') }}" class="img-fluid" alt="post-image">
